...
public class MemberVO { //회원 테이블 정보
    private String role_name=null; //회원권한 회원가입 후 관리자가 UserDetails 로 부여함
    ...
    private Timestamp date_subscription=null; //가입일자 처음엔 null로 받고 DB에 넣을 때
    private Timestamp date_del=null; //탈퇴일자 처음엔 null로 받고 DB에 넣을 때
